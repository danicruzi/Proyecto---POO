...
public class Player extends MovingObject{
	...
	public void draw(Graphics g) {
		...
		if(shieldOn && shieldEffect != null) {
    BufferedImage currentFrame = shieldEffect.getCurrentFrame();
    if(currentFrame != null) {  // Verificación adicional
        ...
        g2d.drawImage(currentFrame, at3, null);  // Usa la variable ya obtenida
    } else {
        System.err.println("Error: El frame del escudo es null");
        // Puedes dibujar un placeholder o simplemente no dibujar nada
    }
}
